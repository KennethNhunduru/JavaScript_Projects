...
document.write("<br>") //Introducing a line break in the output.
...
*This then means specifying the window keyword is optional.*/

//An alternative way of declaring variables.
let modulo = 30 % 9; //this is an expression.
let product = 3 * 4; //This is an expression
window.alert(modulo * product); //This is a statement that includes an expression.